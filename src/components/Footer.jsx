...
const Footer = () => {
    return (
        <footer className="w-full bg-[#0B0D13] pt-16 flex flex-col items-center">
                        ...
                        <div className="bg-[#1A1D26] rounded-2xl px-6 py-4 flex items-center gap-4 min-w-[300px]">
                            ...
                            <div className="w-12 h-12 relative flex-shrink-0">
                                <svg viewBox="0 0 100 100" className="w-full h-full" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M50 95C50 95 90 75 90 35V15L50 5L10 15V35C10 75 50 95 50 95Z" fill="#1A1D26" stroke="gray" strokeWidth="2" />
                                    <path d="M30 30L30 70" stroke="#FF4D4D" strokeWidth="8" strokeLinecap="round" />
                                    <path d="M50 30L50 70" stroke="#4DA6FF" strokeWidth="8" strokeLinecap="round" />
                                    <path d="M70 30L70 70" stroke="#4DA6FF" strokeWidth="8" strokeLinecap="round" />
                                    <path d="M30 50H70" stroke="#4DA6FF" strokeWidth="4" />
                                </svg>
                                <div className="absolute -bottom-2 -left-2 text-[8px] font-bold text-blue-400 tracking-wider">SCHOOLDEEDS</div>
                            </div>
            ...
            {/* Copyright Bar */}
            <div className="w-full h-16 bg-gradient-to-r from-[#114E60] via-[#3B3045] to-[#601D33] flex items-center justify-center">
